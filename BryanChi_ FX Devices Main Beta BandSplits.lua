...
--[[     local dir_path = ConcatPath(reaper.GetResourcePath(), 'Scripts', 'FX Devices', 'FX Layouts')
    ...
    -----------ShortCut-----------
    AllAvailableKeys={r.ImGui_Key_1();r.ImGui_Key_2();r.ImGui_Key_3();r.ImGui_Key_4();r.ImGui_Key_5();r.ImGui_Key_6();r.ImGui_Key_7();r.ImGui_Key_8();r.ImGui_Key_9();r.ImGui_Key_0();
...
--------------------------==  Before GUI (No Loop) ----------------------------
   ...
   --[[  function Link_LT_Param(TrackNumToBeMod, FX_Slt_Indx_ToBeMod, parmlink, PARMLINK_LINKEDPLUGIN,PARMLINK_LINKEDPARMIDX,PARAM_NR, PARMLINK_OFFSET, PARMLINK_SCALE,PARAMOD_BASELINE)
    ...
    ------------------------------------------------------
        ...
        function Show_KBShortcutEditor()   local rv
            ...
            open,OpenKBEditor = r.ImGui_Begin(ctx, 'FX Devices Shortcut Editor', OpenKBEditor, r.ImGui_WindowFlags_TopMost()+r.ImGui_WindowFlags_NoCollapse()+r.ImGui_WindowFlags_NoDocking()--[[ +r.ImGui_WindowFlags_AlwaysAutoResize() ]])
                ...
                if   r.ImGui_BeginPopupModal(ctx, '##Type Key Popup',nil,r.ImGui_WindowFlags_NoTitleBar()|r.ImGui_WindowFlags_NoResize()) then 
                    ...
                    for i, v in pairs(AllAvailableKeys) do 
                        if r.ImGui_IsKeyPressed( ctx, v ) then 
                            local function GetFinalTxt (i) local txt 
                                if Mods == 0 then   txt = i 
                                elseif Mods == Alt then txt = 'Alt + '..i
                                elseif Mods == Ctrl then txt =  'Ctrl + '..i
                                elseif Mods == Shift then  txt =  'Shift + '..i
                                elseif Mods == Apl then txt = 'Cmd + '..i
                                elseif Mods == Alt + Ctrl then  txt =  'Alt + Ctrl + '.. i
                                elseif Mods == Ctrl + Shift then txt =  'Ctrl + Shift + '.. i
                                elseif Mods == Alt + Shift then txt =  'Alt + Shift + '..i
                                elseif Mods == Alt + Apl then txt =  'Alt + Cmd + '..i
                                elseif Mods == Shift + Apl then txt =  'Shift + Cmd + '..i
                                elseif Mods == Ctrl + Apl then txt = 'Ctrl + Cmd'..i
