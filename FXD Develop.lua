...
Apostrophe = r.ImGui_Key_Apostrophe();Backslash = r.ImGui_Key_Backslash(); Backspace = r.ImGui_Key_Backspace(); Comma = r.ImGui_Key_Comma(); Delete = r.ImGui_Key_Delete() ; DownArrow = r.ImGui_Key_DownArrow(); Equal = r.ImGui_Key_Equal();Minus = r.ImGui_Key_Minus(); LeftArrow = r.ImGui_Key_LeftArrow();Period = r.ImGui_Key_Period();RightArrow = r.ImGui_Key_RightArrow(); SemiColon= r.ImGui_Key_Semicolon();Slash = r.ImGui_Key_Slash();Space=r.ImGui_Key_Space();UpArrow = r.ImGui_Key_UpArrow();
}
KB_Shortcut = {}    
Command_ID = {}
