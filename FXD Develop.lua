package.path = debug.getinfo(1, "S").source:match([[^@?(.*j[\/])[^\/]-$]]) .. "?.lua;" -- GET DIRECTORY FOR REQUIRE
            ...
            if r.ImGui_IsWindowHovered(ctx, r.ImGui_HoveredFlags_RootAndChildWindows()) then
                if MouseX > L and MouseX < R - 5 and MouseY > T and MouseY < B then
                    ...
                    elseif IsLBtnClicked and Mods == Shift then
                        ...
                        if ClickedItmNum then table.remove(LE.Sel_Items, ClickedItmNum) else table.insert(LE.Sel_Items,
                                Fx_P) end
                    end
                                    ...
                                    if Draw.DrawMode[FxGUID] == true then
                                        ...
                                        if r.ImGui_IsMouseHoveringRect(ctx, Win_L, Win_T, Win_R, Win_B) and HvringItmSelector == nil and not Draw.SelItm and Draw.Time == 0 then
                                            ...
                                            if Draw.CurrentylDrawing then
                                                ...
                                                if Draw.Type == 'Text' and IsLBtnClicked and Mods == 0 then AddText = #D
                                                    .Type + 1 end
                                            end
                                        end
                                    ...
                                    if r.ImGui_BeginPopup(ctx, 'Add Parameter' .. FxGUID, r.ImGui_WindowFlags_AlwaysVerticalScrollbar()) then
                                        ...
                                        for i = 0, Ct - 1, 1 do
                                            ...
                                            if r.ImGui_TextFilter_PassFilter(PrmFilter, P_Name) then
                                                rv, CheckBox[i] = r.ImGui_Checkbox(ctx, (i) .. '. ' .. P_Name,
                                                    CheckBox[i])
                                                if rv then
                                                ...
                                                if Prm then
                                                    ...
                                                    if FP.Draw then
                                                        ...
                                                        for i, v in ipairs(FP.Draw) do
                                                            ...
                                                            local Clr_VA
                                                            if v.Clr_VA then Clr_VA = BlendColors(v.Clr or 0xffffffff,
                                                                    v.Clr_VA, Prm.V) end



                                                            if v.X_Gap_VA and v.X_Gap_VA ~= 0 then X_Gap = (v.X_Gap or 0) *
                                                                Prm.V * v.X_Gap_VA end
                                                            if v.Y_Gap_VA and v.Y_Gap_VA ~= 0 then Y_Gap = (v.Y_Gap or 0) *
                                                                Prm.V * v.Y_Gap_VA end

                                                            if v.Gap_VA and v.Gap_VA ~= 0 then Gap = v.Gap * Prm.V *
                                                                v.Gap_VA end

                                                            if v.Thick_VA then Thick = (v.Thick or 2) *
                                                                (v.Thick_VA * Prm.V) end
                                                            ...
                                                            if v.Type == 'Line' or v.Type == 'Rect' or v.Type == 'Rect Filled' then
                                                                ...
                                                                if v.Width_VA and v.Width_VA ~= 0 then x2 = x +
                                                                    (w or 10) * Prm.V * (v.Width_VA) end
                                                                if v.Height_VA and v.Height_VA ~= 0 then y2 = y +
                                                                    (h or 10) * Prm.V * (v.Height_VA) end
                                                            ...
                                                            elseif v.Type == 'Circle' or v.Type == 'Circle Filled' then
                                                                local w, h = 10
                                                                if Prm.Type == 'Knob' then w, h = r
                                                                    .ImGui_GetItemRectSize(ctx) else v.Width = v.Width or
                                                                    10 end
                                                                local Rad = v.Width or w
                                                                if v.Width_VA and v.Width_VA ~= 0 then Rad = Rad * Prm.V *
                                                                    v.Width_VA end
                                                            ...
                                                            elseif v.Type == 'Image' and v.Image then
                                                                ...
                                                                if v.Width_VA and v.Width_VA ~= 0 then w = (v.Width or w) *
                                                                    v.Width_VA * Prm.V end
                                                                if v.Height_VA and v.Height_VA ~= 0 then h = (v.Height or h) *
                                                                    v.Height_VA * Prm.V end
                                ...
                                elseif LE.Sel_Items[1] then
                                    ...
                                    local function Condition(ConditionPrm, ConditionPrm_PID, ConditionPrm_V,
                                        ...
                                        if FrstSelItm[ShowCondition] or FX[FxGUID][P][ConditionPrm] then
                                            ...
                                            if fp[ConditionPrm] then _, PrmName = r.TrackFX_GetParamName(LT_Track, FX_Idx,
                                                    fp[ConditionPrm]) end
                                            ...
                                            if PrmName then
                                                ...
                                                if Value_Selected then
                                                    for i, v in pairs(LE.Sel_Items) do
                                                        ...
                                                        .TrackFX_GetParamNormalized(LT_Track, FX_Idx, fp[ConditionPrm])
                                                    end
                                                end
                                        ...
                                        for i = 1, #FrstSelItm.Draw, 1 do
                                            ...
                                            if rv then
                                                ...
                                                if r.ImGui_BeginTable(ctx, 'testtable', 3, flags, -R_ofs) then
                                                    ...
                                                    if SetRowName('Angle Min', nil, BL_XYGap) then AddVal('Angle_Min',
                                                            0.75, 0.01, 0, 3.14, '%.3f', true) end
                                                    if SetRowName('Angle Max', nil, BL_XYGap) then AddVal('Angle_Max',
                                                            2.25, 0.01, 0, 3.14, '%.3f', true) end
                                                    if SetRowName('Radius Inner', nil, RadiusInOut) then AddVal('Rad_In',
                                                            0, 0.1, 0, 300, '%.3f', true) end
                                                    if SetRowName('Radius Outer', nil, RadiusInOut) then AddVal(
                                                        'Rad_Out', 30, 0.1, 0, 300, '%.3f', true) end
                                                    if SetRowName('Radius', nil, Radius) then AddVal('Rad_In', 0, 0.1, 0,
                                                            300, '%.3f', true) end

                                                    if SetRowName('Thickness', nil, Thick) then AddVal('Thick', 2, 0.5, 0,
                                                            60, '%.1f', true) end
                                                    if SetRowName('Edge Round', nil, Round) then AddVal('Round', 0, 0.1,
                                                            0, 100, '%.1f', true) end
                                                    SetRowName('Color')
                                                    r.ImGui_TableSetColumnIndex(ctx, 1)
