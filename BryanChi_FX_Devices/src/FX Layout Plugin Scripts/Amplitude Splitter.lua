    ...
    function DrawContainerContents()
        ...
        if count_num == 0 then
            ...
            if targ_pos then
                ...
                local enclosure_color = (fx.ChosenContainer == "Transient") and Transient_Color or Sustain_Color
                local draw_list = im.GetWindowDrawList(ctx)
        ...
        -- Add extra width so FX content is not cropped: SameLine spacing (20) + right-edge buffer (20) - 50 adjustment
        fx.Width = fx.Width - 10
...
function HandleContainerDragDrop(button_type, container_guid, container_idx, glow_color)
    ...
    if im.BeginDragDropTarget(ctx) then
        ...
        im.DrawList_AddRect(draw_list, min_x, min_y, max_x, max_y, glow_color, 6.0, nil, 2.0)
